...
public class ti_sdo_ce_examples_extensions_scale
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/scale.ae674',\n");
            sb.append("'lib/scale_debug.ae674',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/scale.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/scale_debug.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/scale.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/scale_debug.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
        sb.append("];\n");
