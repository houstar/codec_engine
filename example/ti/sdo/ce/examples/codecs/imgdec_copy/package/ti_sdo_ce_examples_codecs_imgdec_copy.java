...
public class ti_sdo_ce_examples_codecs_imgdec_copy
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/imgdec_copy.a674',\n");
            sb.append("'lib/imgdec_copy.ae674',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/imgdec_copy.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/imgdec_copy.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
        sb.append("];\n");
