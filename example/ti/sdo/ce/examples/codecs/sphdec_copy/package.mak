...
override PKGDIR = ti/sdo/ce/examples/codecs/sphdec_copy
...
package/%.xdc.inc package/%_ti.sdo.ce.examples.codecs.sphdec_copy.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ce.examples.codecs.sphdec_copy" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ce.examples.codecs.sphdec_copy $@

.libraries,674 .libraries: lib/sphdec_copy.a674

-include lib/sphdec_copy.a674.mak
lib/sphdec_copy.a674: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/sphdec_copy/package/package_ti.sdo.ce.examples.codecs.sphdec_copy.o674 package/lib/lib/sphdec_copy/sphdec_copy.o674  into $@ ...
	$(ti.targets.C674.rootDir)/bin/ar6x  rq $@   package/lib/lib/sphdec_copy/package/package_ti.sdo.ce.examples.codecs.sphdec_copy.o674 package/lib/lib/sphdec_copy/sphdec_copy.o674 
lib/sphdec_copy.a674: export C_DIR=
lib/sphdec_copy.a674: PATH:=$(ti.targets.C674.rootDir)/bin/:$(PATH)

clean,674 clean::
	-$(RM) lib/sphdec_copy.a674
.libraries,e674 .libraries: lib/sphdec_copy.ae674

-include lib/sphdec_copy.ae674.mak
lib/sphdec_copy.ae674: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/sphdec_copy/package/package_ti.sdo.ce.examples.codecs.sphdec_copy.oe674 package/lib/lib/sphdec_copy/sphdec_copy.oe674  into $@ ...
	$(ti.targets.elf.C674.rootDir)/bin/ar6x  rq $@   package/lib/lib/sphdec_copy/package/package_ti.sdo.ce.examples.codecs.sphdec_copy.oe674 package/lib/lib/sphdec_copy/sphdec_copy.oe674 
lib/sphdec_copy.ae674: export C_DIR=
lib/sphdec_copy.ae674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/:$(PATH)

clean,e674 clean::
	-$(RM) lib/sphdec_copy.ae674
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
package_ti.sdo.ce.examples.codecs.sphdec_copy.o674,copy : package/lib/lib/sphdec_copy/package/package_ti.sdo.ce.examples.codecs.sphdec_copy.o674
package_ti.sdo.ce.examples.codecs.sphdec_copy.s674,copy : package/lib/lib/sphdec_copy/package/package_ti.sdo.ce.examples.codecs.sphdec_copy.s674
sphdec_copy.o674,copy : package/lib/lib/sphdec_copy/sphdec_copy.o674
sphdec_copy.s674,copy : package/lib/lib/sphdec_copy/sphdec_copy.s674
package_ti.sdo.ce.examples.codecs.sphdec_copy.oe674,copy : package/lib/lib/sphdec_copy/package/package_ti.sdo.ce.examples.codecs.sphdec_copy.oe674
package_ti.sdo.ce.examples.codecs.sphdec_copy.se674,copy : package/lib/lib/sphdec_copy/package/package_ti.sdo.ce.examples.codecs.sphdec_copy.se674
sphdec_copy.oe674,copy : package/lib/lib/sphdec_copy/sphdec_copy.oe674
sphdec_copy.se674,copy : package/lib/lib/sphdec_copy/sphdec_copy.se674

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sdo_ce_examples_codecs_sphdec_copy
ti_sdo_ce_examples_codecs_sphdec_copy.tar: package/package.bld.xml
ti_sdo_ce_examples_codecs_sphdec_copy.tar: package/package.ext.xml
ti_sdo_ce_examples_codecs_sphdec_copy.tar: package/package.rel.dot
ti_sdo_ce_examples_codecs_sphdec_copy.tar: package/build.cfg
ti_sdo_ce_examples_codecs_sphdec_copy.tar: package/package.xdc.inc
ti_sdo_ce_examples_codecs_sphdec_copy.tar: package/package.cfg.xdc.inc
ti_sdo_ce_examples_codecs_sphdec_copy.tar: lib/sphdec_copy.a674
ti_sdo_ce_examples_codecs_sphdec_copy.tar: lib/sphdec_copy.ae674
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ce_examples_codecs_sphdec_copy.tar.dep
endif
package/rel/ti_sdo_ce_examples_codecs_sphdec_copy/ti/sdo/ce/examples/codecs/sphdec_copy/package/package.rel.xml:

ti_sdo_ce_examples_codecs_sphdec_copy.tar: package/rel/ti_sdo_ce_examples_codecs_sphdec_copy.xdc.inc package/rel/ti_sdo_ce_examples_codecs_sphdec_copy/ti/sdo/ce/examples/codecs/sphdec_copy/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ce_examples_codecs_sphdec_copy.xdc.inc,package/rel/ti_sdo_ce_examples_codecs_sphdec_copy.tar.dep)


release release,ti_sdo_ce_examples_codecs_sphdec_copy: all ti_sdo_ce_examples_codecs_sphdec_copy.tar
clean:: .clean
	-$(RM) ti_sdo_ce_examples_codecs_sphdec_copy.tar
	-$(RM) package/rel/ti_sdo_ce_examples_codecs_sphdec_copy.xdc.inc
	-$(RM) package/rel/ti_sdo_ce_examples_codecs_sphdec_copy.tar.dep
...
ifeq (,$(wildcard package/lib/lib/sphdec_copy))
    $(shell $(MKDIR) package/lib/lib/sphdec_copy)
endif
ifeq (,$(wildcard package/lib/lib/sphdec_copy/package))
    $(shell $(MKDIR) package/lib/lib/sphdec_copy/package)
endif
endif
clean::
	-$(RMDIR) package
...
clean:: 
	-$(RM) package/ti.sdo.ce.examples.codecs.sphdec_copy.pjt
