                        ...
                        int chanNum)
{
    ...
    static double num_bit, snr[SBMAX_L];
    static double energy[BLOCK_LEN_LONG], snr_p[BLOCK_LEN_LONG], temp1, temp2;
    ChannelInfo *thisChannel;

    /* Set pointers for specified channel number */
    /* int psy_init; */
    int *psy_init;
    static double (*dr)[BLOCK_LEN_LONG],(*e)[BLOCK_LEN_LONG];
    static double (*K)[BLOCK_LEN_LONG], (*R)[BLOCK_LEN_LONG];
    static double (*VAR)[BLOCK_LEN_LONG], (*KOR)[BLOCK_LEN_LONG];
