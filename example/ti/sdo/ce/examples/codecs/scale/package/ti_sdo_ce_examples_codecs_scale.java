...
public class ti_sdo_ce_examples_codecs_scale
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/scale_ti.ae674',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/scale_ti.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/scale_ti.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
        sb.append("];\n");
    ...
    void SCALE_TI$$SINGLETONS()
    {
        ...
        inherits.add("ti.sdo.ce.examples.extensions.scale");
