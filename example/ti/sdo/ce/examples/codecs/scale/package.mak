...
override PKGDIR = ti/sdo/ce/examples/codecs/scale
...
package/%.xdc.inc package/%_ti.sdo.ce.examples.codecs.scale.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ce.examples.codecs.scale" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ce.examples.codecs.scale $@

.libraries,674 .libraries: lib/scale_ti.a674

-include lib/scale_ti.a674.mak
lib/scale_ti.a674: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/scale_ti/package/package_ti.sdo.ce.examples.codecs.scale.o674 package/lib/lib/scale_ti/scale_ti_impl.o674  into $@ ...
	$(ti.targets.C674.rootDir)/bin/ar6x  rq $@   package/lib/lib/scale_ti/package/package_ti.sdo.ce.examples.codecs.scale.o674 package/lib/lib/scale_ti/scale_ti_impl.o674 
lib/scale_ti.a674: export C_DIR=
lib/scale_ti.a674: PATH:=$(ti.targets.C674.rootDir)/bin/:$(PATH)

clean,674 clean::
	-$(RM) lib/scale_ti.a674
.libraries,e674 .libraries: lib/scale_ti.ae674

-include lib/scale_ti.ae674.mak
lib/scale_ti.ae674: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/scale_ti/package/package_ti.sdo.ce.examples.codecs.scale.oe674 package/lib/lib/scale_ti/scale_ti_impl.oe674  into $@ ...
	$(ti.targets.elf.C674.rootDir)/bin/ar6x  rq $@   package/lib/lib/scale_ti/package/package_ti.sdo.ce.examples.codecs.scale.oe674 package/lib/lib/scale_ti/scale_ti_impl.oe674 
lib/scale_ti.ae674: export C_DIR=
lib/scale_ti.ae674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/:$(PATH)

clean,e674 clean::
	-$(RM) lib/scale_ti.ae674
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
package_ti.sdo.ce.examples.codecs.scale.o674,copy : package/lib/lib/scale_ti/package/package_ti.sdo.ce.examples.codecs.scale.o674
package_ti.sdo.ce.examples.codecs.scale.s674,copy : package/lib/lib/scale_ti/package/package_ti.sdo.ce.examples.codecs.scale.s674
scale_ti_impl.o674,copy : package/lib/lib/scale_ti/scale_ti_impl.o674
scale_ti_impl.s674,copy : package/lib/lib/scale_ti/scale_ti_impl.s674
package_ti.sdo.ce.examples.codecs.scale.oe674,copy : package/lib/lib/scale_ti/package/package_ti.sdo.ce.examples.codecs.scale.oe674
package_ti.sdo.ce.examples.codecs.scale.se674,copy : package/lib/lib/scale_ti/package/package_ti.sdo.ce.examples.codecs.scale.se674
scale_ti_impl.oe674,copy : package/lib/lib/scale_ti/scale_ti_impl.oe674
scale_ti_impl.se674,copy : package/lib/lib/scale_ti/scale_ti_impl.se674

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sdo_ce_examples_codecs_scale
ti_sdo_ce_examples_codecs_scale.tar: package/package.bld.xml
ti_sdo_ce_examples_codecs_scale.tar: package/package.ext.xml
ti_sdo_ce_examples_codecs_scale.tar: package/package.rel.dot
ti_sdo_ce_examples_codecs_scale.tar: package/build.cfg
ti_sdo_ce_examples_codecs_scale.tar: package/package.xdc.inc
ti_sdo_ce_examples_codecs_scale.tar: package/package.cfg.xdc.inc
ti_sdo_ce_examples_codecs_scale.tar: lib/scale_ti.a674
ti_sdo_ce_examples_codecs_scale.tar: lib/scale_ti.ae674
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ce_examples_codecs_scale.tar.dep
endif
package/rel/ti_sdo_ce_examples_codecs_scale/ti/sdo/ce/examples/codecs/scale/package/package.rel.xml:

ti_sdo_ce_examples_codecs_scale.tar: package/rel/ti_sdo_ce_examples_codecs_scale.xdc.inc package/rel/ti_sdo_ce_examples_codecs_scale/ti/sdo/ce/examples/codecs/scale/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ce_examples_codecs_scale.xdc.inc,package/rel/ti_sdo_ce_examples_codecs_scale.tar.dep)


release release,ti_sdo_ce_examples_codecs_scale: all ti_sdo_ce_examples_codecs_scale.tar
clean:: .clean
	-$(RM) ti_sdo_ce_examples_codecs_scale.tar
	-$(RM) package/rel/ti_sdo_ce_examples_codecs_scale.xdc.inc
	-$(RM) package/rel/ti_sdo_ce_examples_codecs_scale.tar.dep
...
ifeq (,$(wildcard package/lib/lib/scale_ti))
    $(shell $(MKDIR) package/lib/lib/scale_ti)
endif
ifeq (,$(wildcard package/lib/lib/scale_ti/package))
    $(shell $(MKDIR) package/lib/lib/scale_ti/package)
endif
endif
clean::
	-$(RMDIR) package
...
clean:: 
	-$(RM) package/ti.sdo.ce.examples.codecs.scale.pjt
