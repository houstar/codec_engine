...
override PKGDIR = ti/sdo/ce/examples/codecs/audenc1_copy
...
package/%.xdc.inc package/%_ti.sdo.ce.examples.codecs.audenc1_copy.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ce.examples.codecs.audenc1_copy" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ce.examples.codecs.audenc1_copy $@
...
.PHONY: release,ti_sdo_ce_examples_codecs_audenc1_copy
ti_sdo_ce_examples_codecs_audenc1_copy.tar: package/package.bld.xml
ti_sdo_ce_examples_codecs_audenc1_copy.tar: package/package.ext.xml
ti_sdo_ce_examples_codecs_audenc1_copy.tar: package/package.rel.dot
ti_sdo_ce_examples_codecs_audenc1_copy.tar: package/build.cfg
ti_sdo_ce_examples_codecs_audenc1_copy.tar: package/package.xdc.inc
ti_sdo_ce_examples_codecs_audenc1_copy.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ce_examples_codecs_audenc1_copy.tar.dep
endif
package/rel/ti_sdo_ce_examples_codecs_audenc1_copy/ti/sdo/ce/examples/codecs/audenc1_copy/package/package.rel.xml:

ti_sdo_ce_examples_codecs_audenc1_copy.tar: package/rel/ti_sdo_ce_examples_codecs_audenc1_copy.xdc.inc package/rel/ti_sdo_ce_examples_codecs_audenc1_copy/ti/sdo/ce/examples/codecs/audenc1_copy/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ce_examples_codecs_audenc1_copy.xdc.inc,package/rel/ti_sdo_ce_examples_codecs_audenc1_copy.tar.dep)


release release,ti_sdo_ce_examples_codecs_audenc1_copy: all ti_sdo_ce_examples_codecs_audenc1_copy.tar
clean:: .clean
	-$(RM) ti_sdo_ce_examples_codecs_audenc1_copy.tar
	-$(RM) package/rel/ti_sdo_ce_examples_codecs_audenc1_copy.xdc.inc
	-$(RM) package/rel/ti_sdo_ce_examples_codecs_audenc1_copy.tar.dep
