...
InteractionMode_IPC::InteractionMode_IPC(Kernel* pKernel) :
		MixtureMode_IPC(pKernel) {
}

InteractionMode_IPC::~InteractionMode_IPC() {

}


bool InteractionMode_IPC::calcScalerWidthHeight() {
	bool bRet = false;
...
void InteractionMode_IPC::onWriteTask(ComponentWrapper *aComponent) {
