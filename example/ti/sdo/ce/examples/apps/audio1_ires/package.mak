...
override PKGDIR = ti/sdo/ce/examples/apps/audio1_ires
...
package/%.xdc.inc package/%_ti.sdo.ce.examples.apps.audio1_ires.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ce.examples.apps.audio1_ires" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ce.examples.apps.audio1_ires $@
...
.PHONY: release,ti_sdo_ce_examples_apps_audio1_ires
ti_sdo_ce_examples_apps_audio1_ires.tar: package/package.bld.xml
ti_sdo_ce_examples_apps_audio1_ires.tar: package/package.ext.xml
ti_sdo_ce_examples_apps_audio1_ires.tar: package/package.rel.dot
ti_sdo_ce_examples_apps_audio1_ires.tar: package/build.cfg
ti_sdo_ce_examples_apps_audio1_ires.tar: package/package.xdc.inc
ti_sdo_ce_examples_apps_audio1_ires.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ce_examples_apps_audio1_ires.tar.dep
endif
package/rel/ti_sdo_ce_examples_apps_audio1_ires/ti/sdo/ce/examples/apps/audio1_ires/package/package.rel.xml:

ti_sdo_ce_examples_apps_audio1_ires.tar: package/rel/ti_sdo_ce_examples_apps_audio1_ires.xdc.inc package/rel/ti_sdo_ce_examples_apps_audio1_ires/ti/sdo/ce/examples/apps/audio1_ires/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ce_examples_apps_audio1_ires.xdc.inc,package/rel/ti_sdo_ce_examples_apps_audio1_ires.tar.dep)


release release,ti_sdo_ce_examples_apps_audio1_ires: all ti_sdo_ce_examples_apps_audio1_ires.tar
clean:: .clean
	-$(RM) ti_sdo_ce_examples_apps_audio1_ires.tar
	-$(RM) package/rel/ti_sdo_ce_examples_apps_audio1_ires.xdc.inc
	-$(RM) package/rel/ti_sdo_ce_examples_apps_audio1_ires.tar.dep
